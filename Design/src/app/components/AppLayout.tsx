    ...
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col lg:flex-row">
      ...
      >
        ...
        <button
          ...
          className="w-full px-6 py-4 bg-[#05272e] hover:bg-[#05272e]/90 transition-colors text-left"
        >
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-[#D8D8D8] flex items-center justify-center overflow-hidden">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-bold text-white text-sm">Dr. Nawaz M</div>
              <div className="flex items-center gap-1 mt-1">
                <div className="w-2 h-2 bg-[#55AA2F] rounded-full" />
                <span className="text-white text-xs">Plan C</span>
              </div>
            </div>
          </div>
          <div className="mt-3">
            <p className="text-sm text-white">
              Course: <span className="text-[#5B8DB8]">NEET PG</span>
            </p>
          </div>
        </button>
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-auto pt-16 lg:pt-20 lg:pl-64 lg:pr-0">
